/*
 * DS3232RTC.h - library for DS3231 or DS3232 RTC
  
  Credit: Copyright (c) Michael Margolis 2009
...
//////////////////////////////////////////////////////////////
function DS3232RTC::get()   // Aquire data from buffer and convert to time_t
{
...
//  tm.Year = y2kYearToTm(bcd2dec(i2c.read8(0x06))); // register addr 6
...
//////////////////////////////////////////////////////////////
function DS3232RTC::write(tmArray)
{
  tm = clone tmArray;
  i2c.address(addr);
...
// Description:	Read temperature from the RTC
// Arguments:	None
// Return:	    Temperature in Celcius
//////////////////////////////////////////////////////////////

function DS3232RTC::temperature()
{
//    union int16_byte {
//        int i;
//        byte b[2];
//    } rtcTemp;
    ...
    rtcTemp0 = i2c.read8(0x11);  // TEMP_MSB
    rtcTemp1 = i2c.read8(0x12);  // TEMP_LSB
    
    tempV = rtcTemp1 | (rtcTemp0<<8);
    tempV = tempV & 0x7FFF;
    tempV = tempV >> 6;
    if ((rtcTemp0 & 0x80) > 0) tempV = -tempV;
    tempV /= 4.0;
    
//    rtcTemp1 = rtcTemp1 >> 6;
//    tempV = (rtcTemp0 & 0x7F)<<2;
//    tempV = tempV | rtcTemp1;
//    tempV = tempV / 4;
    return tempV;
}
...
function DS3232RTC::dec2bcd(num)
{
...
function DS3232RTC::bcd2dec(num)
{
...
//////////////////////////////////////////////////////////////
// 
function DS3232RTC::y2kYearToTm(num)
{
...
//////////////////////////////////////////////////////////////
// 
function DS3232RTC::tmYearToY2k(num)
{
  //convenience macros to convert to and from tm years 
